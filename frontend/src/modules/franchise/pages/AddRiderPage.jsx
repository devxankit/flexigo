    ...
    <div className="space-y-4 pb-12">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-3">
        ...
        <div className="lg:col-span-2 space-y-3">
          <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-4 shadow-inner space-y-4">
            <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <div className="p-2.5 bg-white/[0.03] border border-white/5 rounded-xl flex items-center gap-2 focus-within:border-emerald-500/30 transition-all shadow-inner group">
                  ...
                  <input
                    ...
                    className="bg-transparent border-none outline-none text-[8.5px] font-black italic text-white w-full placeholder:text-slate-800 tracking-widest"
                    value={formData.name}
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-2">
                  <div className={`flex-1 p-2.5 bg-white/[0.03] border ${isAadhaarVerified ? 'border-emerald-500/50' : 'border-white/5'} rounded-xl flex items-center gap-2 transition-all shadow-inner group`}>
                ...
                {otpSent && !isAadhaarVerified && (
                  <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="flex gap-2 mt-2">
                    <div className="flex-1 p-2.5 bg-white/[0.03] border border-emerald-500/30 rounded-xl flex items-center gap-2 transition-all shadow-inner">
          ...
          <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-4 shadow-inner space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <div className="relative p-2.5 bg-white/[0.03] border border-white/5 rounded-xl flex items-center gap-2 focus-within:border-blue-500/30 transition-all shadow-inner group">
                ...
                <div className="relative p-2.5 bg-white/[0.03] border border-white/5 rounded-xl flex items-center gap-2 focus-within:border-blue-500/30 transition-all shadow-inner group">
                  ...
                  >
                    ...
                    {vehicles.filter(v => v.status === 'available').map(v => (
                      <option key={v._id} value={v._id} className="bg-slate-900">{v.plate} • {v.model.toUpperCase()}</option>
                    ))}
                  </select>
                  <ChevronRight size={10} strokeWidth={3} className="absolute right-2 rotate-90 text-slate-800 pointer-events-none" />
                </div>
